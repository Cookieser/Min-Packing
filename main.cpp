...
//generate keys
	    ...
	    mpz_t a,b,q,base,change,two,x,cx,ca,cb,cq,negone,r,cr,res,z,cz,rl,c,d,zl,t,ct,crl,czl,cm,cn,cres;
	    mpz_inits(a,b,q,base,change,two,x,cx,ca,cb,cq,negone,r,cr,res,z,cz,rl,c,d,zl,t,ct,crl,czl,cm,cn,cres,NULL);
	   ...
	   //encoding a	
	   encoding(block,l,"a.txt","encoding_a",a);
	   gmp_printf ("a:%Zd\n",a);
	   paillier_encrypt(ca,a,&pub);
	   
	   //encoding b	
	   encoding(block,l,"b.txt","encoding_b",b);
	   gmp_printf ("b:%Zd\n",b);
