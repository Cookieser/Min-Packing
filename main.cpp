...
#include "seal_encrypted_comparing.cpp"
...
/*	KeyGenerate  */
   ...
   for(int i=1; i<k;i++){
    ...
    Plaintext bi_plain;
    vector<uint64_t> matrix_bi(slot_count, 0ULL);  
    matrix_bi=seal_encrypted_comparing(max_encrypted, apii_encrypted,context,secret_key,public_key,relin_keys,l,lambda);
 ...
 //seal_encrypted_comparing(max_encrypted, apii_encrypted,context,secret_key,public_key,relin_keys,l,lambda,plain_result);
