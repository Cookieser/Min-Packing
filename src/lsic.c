...
int LSIC(mpz_t a,mpz_t b, int l,mpz_t ct,paillier_public_key pub,paillier_private_key priv) {
	...
	//1-6
	    ...
	    mpz_t a0,b0,cb0,t,zero,czero,one,cone,negativeone,ctau,ai,bi,cbi,tb,ctb;

	  
	    mpz_inits(a0,b0,cb0,t,ctb,cbi,ctau,zero,czero,one,cone,negativeone,ai,bi,tb,NULL);
